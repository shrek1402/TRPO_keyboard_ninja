...
TEST_CASE("GetStringTest", "[Num_tests]")
{
    ...
    REQUIRE(GetString("sourcs/bin/data/Numbers.txt", array) == 1);
    REQUIRE(GetString("sourcs/bin/data/Calculator.txt", array) == 1);
    REQUIRE(GetString("sourcs/bin/data/Equation.txt", array) == 1);
    REQUIRE(GetString("sourcs/bin/data/EquationAnswers.txt", array) == 1);
}
