...
allTests = build/test/reaction.o build/test/getXX.o build/test/getYY.o build/test/coordinate_test.o build/test/result_test.o
...
bin/Keyboard-Ninja-test: $(allTests)
	g++ $(CFLAGS) build/src/kmenu.o build/src/typing_tutor.o -lncurses $^ -o $@
